...
final class LanguageManager {
    ...
    private static let strings: [String: [String: String]] = [
        ...
        "生涯非課税枠": ["zh-Hans": "终身免税额度", "zh-Hant": "終身免稅額度", "en": "Lifetime Tax-Free", "ja": "生涯非課税枠"],
        "枠の再利用": ["zh-Hans": "额度复活", "zh-Hant": "額度復活", "en": "Quota Recovery", "ja": "枠の再利用"],
        ...
        "超出NISA生涯非課税枠": ["zh-Hans": "超出NISA终身免税额度(1800万)", "zh-Hant": "超出NISA終身免稅額度(1800萬)", "en": "Exceeds NISA lifetime limit (¥18M)", "ja": "NISA生涯非課税枠(1800万)を超過"],
        "超出成長枠生涯上限": ["zh-Hans": "超出成长枠终身上限(1200万)", "zh-Hant": "超出成長枠終身上限(1200萬)", "en": "Exceeds Growth lifetime limit (¥12M)", "ja": "成長枠の生涯上限(1200万)を超過"],
